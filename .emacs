...
(push "/opt/matlab/java/extern/EmacsLink/lisp" load-path)
...
(setq user-full-name "Liu Kai")
(setq user-mail-address "liukai.sea@gmail.com")
;;设置有用的个人信息,这在很多地方有用。
...
(setq diary-mail-addr "liukai.sea@gmail.com")
...
;;                            header-blank
;;                            ))
;;(setq header-copyright-notice "  by SEA" )
...
(add-to-list 'load-path "/usr/local/share/emacs/cedet-1.0pre6/speedbar")
(add-to-list 'load-path "/usr/local/share/emacs/cedet-1.0pre6/eieio")
(add-to-list 'load-path "/usr/local/share/emacs/cedet-1.0pre6/semantic")
(add-to-list 'load-path "/usr/local/share/emacs/cedet-1.0pre6/common")
(require 'cedet)
